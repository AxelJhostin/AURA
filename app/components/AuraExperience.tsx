...
import { OpportunityCircleGuide } from "./OpportunityCircleGuide";
...
const text = {
  es: {
    ...
    navPilot: "Piloto",
    navTeam: "Equipo",
    navCta: "Probar un caso",
    hackathon: "AURA OPPORTUNITY CIRCLES · UNESCO YOUTH HACKATHON 2026",
    heroTitleA: "Antes de entregar tus datos,",
    heroTitleB: "investiga la oportunidad.",
    heroBody:
      "Entrena cómo comprobar becas, empleos, intercambios y programas juveniles antes de entregar documentos, dinero o confianza.",
    start: "Investigar una oportunidad",
    explore: "Conocer el método",
    heroNote: "Caso simulado · Sin registro · No solicita datos reales · 6–8 minutos",
    artifact: "Artefacto de aprendizaje",
    cardStatus: "Conclusión trazable",
    claim: "Afirmación",
    claimShort: "“500 becas; registro hasta hoy”",
    evidence: "Evidencia",
    evidenceShort: "Fuente primaria + contexto",
    action: "Acción",
    actionShort: "Proteger datos y comprobar",
    previewStages: ["ANALIZA", "UBICA", "RASTREA", "ACTÚA"],
    proofOne: "Becas, empleos e intercambios",
    proofTwo: "Sesiones dirigidas por jóvenes",
    proofThree: "Transferencia medible",
    caseLibraryEyebrow: "OPPORTUNITY CIRCLES · MISIONES",
    caseLibraryTitle: "Elige una oportunidad para investigar",
    caseActive: "Caso activo",
    analyticsTitle: "Medición anónima del aprendizaje",
    analyticsBody:
      "AURA puede enviar eventos codificados —opciones, tiempo, puntuación y un pulso pre/post de 1 a 5— para evaluar el Circle. No incluye nombres, correos, texto libre, IP ni historial.",
    ...
    missionEyebrow: "OPPORTUNITY CIRCLE · CASO 01",
    missionTitle: "Protege tus datos sin perder una oportunidad real",
    missionBody:
      "Rastrea la convocatoria, el dominio y el responsable antes de entregar documentos, dinero o credenciales.",
    ...
    realReferencesBody:
      "Estas referencias oficiales respaldan los patrones de riesgo y el método de verificación. No sustituyen las piezas simuladas del caso.",
    published: "Publicado",
    accessed: "Consultado",
    openReference: "Abrir referencia original",
    mapClaim: "Promesa recibida",
    ...
    differenceTitle: "No es un directorio de becas ni un detector de estafas.",
    differenceBody:
      "Una alerta resuelve un mensaje. AURA entrena la habilidad para protegerse ante la siguiente oportunidad urgente.",
    commonModelLabel: "MODELO COMÚN",
    auraModelLabel: "MODELO AURA",
    versusA: "Una alerta que decide por ti",
    versusAText: "La herramienta marca el mensaje y la persona depende del siguiente aviso.",
    versusB: "Una práctica que cambia conducta",
    versusBText: "La persona rastrea el origen, protege sus datos y demuestra transferencia.",
    principles: [
      "La IA pregunta antes de explicar.",
      "La convocatoria y sus fuentes permanecen visibles.",
      "La incertidumbre es una salida válida.",
      "El progreso mide acciones, no creencias.",
    ],
    pilotEyebrow: "OPPORTUNITY CIRCLES · ECUADOR",
    pilotTitle: "De una práctica individual a una red juvenil",
    pilotBody:
      "Cada Circle combina una misión guiada, conversación entre pares y un reto sin pistas. Estas son metas de validación, no resultados inventados.",
    pilotStats: [
      ["30–50", "participantes objetivo"],
      ["2+", "Circles iniciales"],
      ["20–30 min", "sesión facilitada"],
      ["0", "datos sensibles requeridos"],
    ],
    pilotSteps: [
      ["01", "Practicar", "Resolver una oportunidad simulada con el método A-U-R-A."],
      ["02", "Conversar", "Comparar decisiones y riesgos con otras personas jóvenes."],
      ["03", "Transferir", "Resolver sin pistas una oportunidad desconocida."],
      ["04", "Multiplicar", "Preparar a otra persona para facilitar el siguiente Circle."],
    ],
    ...
    roadmapEyebrow: "ESTADO DE OPPORTUNITY CIRCLES",
    roadmapTitle: "Producto listo para pilotos.",
    roadmapItems: [
      ["Producto", "Cuatro casos bilingües, transferencia, IA responsable y analítica anónima."],
      ["Campo", "Dos Circles reales, métricas honestas y revisión externa AMI."],
      ["Postulación", "Resultados, propuesta en inglés, video de tres minutos y envío final."],
    ],
    ...
    footerTagline: "Opportunity Circles.",
    footerNote: "De oportunidades urgentes a decisiones informadas · Ecuador · 2026",
  },
  en: {
    homeLabel: "AURA, home",
    ...
    navCta: "Try a case",
    hackathon: "AURA OPPORTUNITY CIRCLES · UNESCO YOUTH HACKATHON 2026",
    heroTitleA: "Before giving away your data,",
    heroTitleB: "investigate the opportunity.",
    heroBody:
      "Train how to check scholarships, jobs, exchanges and youth programmes before giving away documents, money or trust.",
    start: "Investigate an opportunity",
    explore: "Explore the method",
    heroNote: "Simulated case · No sign-up · No real data requested · 6–8 minutes",
    artifact: "Learning artifact",
    cardStatus: "Traceable conclusion",
    claim: "Claim",
    claimShort: "“500 scholarships; register today”",
    evidence: "Evidence",
    evidenceShort: "Primary source + context",
    action: "Action",
    actionShort: "Protect data and verify",
    previewStages: ["ASSESS", "UNCOVER", "RESEARCH", "ACT"],
    proofOne: "Scholarships, jobs and exchanges",
    proofTwo: "Youth-led sessions",
    proofThree: "Measurable transfer",
    caseLibraryEyebrow: "OPPORTUNITY CIRCLES · MISSIONS",
    caseLibraryTitle: "Choose an opportunity to investigate",
    caseActive: "Active case",
    analyticsTitle: "Anonymous learning measurement",
    analyticsBody:
      "AURA can send coded events—options, time, score and a 1–5 pre/post pulse—to evaluate the Circle. It includes no names, emails, free text, IP addresses or browsing history.",
    ...
    missionEyebrow: "OPPORTUNITY CIRCLE · CASE 01",
    missionTitle: "Protect your data without missing a real opportunity",
    missionBody:
      "Trace the call, domain and accountable owner before providing documents, money or credentials.",
    ...
    realReferencesBody:
      "These official references support the risk patterns and verification method. They do not replace the simulated case materials.",
    published: "Published",
    accessed: "Accessed",
    openReference: "Open original reference",
    mapClaim: "Received promise",
    ...
    differenceTitle: "Not a scholarship directory or scam detector.",
    differenceBody:
      "An alert resolves one message. AURA trains the skill needed to face the next urgent opportunity.",
    commonModelLabel: "COMMON MODEL",
    auraModelLabel: "AURA MODEL",
    versusA: "An alert that decides for you",
    versusAText: "The tool labels the message and the person depends on the next warning.",
    versusB: "Practice that changes behavior",
    versusBText: "The person traces the origin, protects their data and demonstrates transfer.",
    principles: [
      "AI asks before explaining.",
      "The call and its sources remain visible.",
      "Uncertainty is a valid output.",
      "Progress measures actions, not beliefs.",
    ],
    pilotEyebrow: "OPPORTUNITY CIRCLES · ECUADOR",
    pilotTitle: "From individual practice to a youth network",
    pilotBody:
      "Each Circle combines a guided mission, peer conversation and a no-clue challenge. These are validation targets, not invented results.",
    pilotStats: [
      ["30–50", "target participants"],
      ["2+", "initial Circles"],
      ["20–30 min", "facilitated session"],
      ["0", "sensitive data required"],
    ],
    pilotSteps: [
      ["01", "Practise", "Solve a simulated opportunity with the A-U-R-A method."],
      ["02", "Discuss", "Compare decisions and risks with other young people."],
      ["03", "Transfer", "Solve an unfamiliar opportunity without clues."],
      ["04", "Multiply", "Prepare another young person to facilitate the next Circle."],
    ],
    ...
    roadmapEyebrow: "OPPORTUNITY CIRCLES STATUS",
    roadmapTitle: "Product ready for pilots.",
    roadmapItems: [
      ["Product", "Four bilingual cases, transfer, responsible AI and anonymous analytics."],
      ["Fieldwork", "Two real Circles, honest metrics and external MIL review."],
      ["Submission", "Results, English proposal, three-minute video and final submission."],
    ],
    ...
    footerTagline: "Opportunity Circles.",
    footerNote: "From urgent opportunities to informed decisions · Ecuador · 2026",
  },
} as const;
    ...
    <main>
      ...
      <header className="site-header">
        <a className="brand" href="#inicio" aria-label={t.homeLabel}>
          ...
          <span>
            <strong>AURA</strong>
            <small>Opportunity Circles</small>
          </span>
        </a>
      ...
      <section className="pilot-section section-shell" id="piloto">
        ...
        <OpportunityCircleGuide locale={locale} />
        <PilotFacilitator
          locale={locale}
